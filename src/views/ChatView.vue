    ...
    <div class="flex h-screen">
      ...
      >
        <button
          ...
          :class="
            currentPage === Page.Chat ? 'bg-gray-200 dark:bg-gray-600' : ''
          "
        ...
        <button
          class="p-3 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-xl transition-colors"
          :class="
            currentPage === Page.Friend ? 'bg-gray-200 dark:bg-gray-600' : ''
          "
          @click="currentPage = Page.Friend"
        >
          <Users class="text-gray-600 dark:text-gray-300" :size="24" />
        </button>
        <button
          class="p-3 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-xl transition-colors"
        >
        ...
        <button
          class="p-3 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-xl transition-colors"
        >
          <Settings class="text-gray-600 dark:text-gray-300" :size="24" />
        </button>
      </aside>
