		...
		<div class="flex h-screen">
			...
			<aside class="w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 flex flex-col">
				...
				<div class="flex-1 p-4 overflow-y-auto">
					<button class="w-full mb-2 px-4 py-3 flex items-center space-x-3 rounded-lg bg-blue-100 dark:bg-gray-700 hover:bg-blue-200 dark:hover:bg-gray-600 transition-colors">
						<Plus
							size="20"
					...
					<div class="mt-6">
						<h3 class="px-2 text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">
							对话历史
						</h3>
						<div class="space-y-1">
							<button
			...
			<main class="flex-1 flex flex-col dark:bg-gray-800 bg-white">
				...
				<div class="flex-1 flex flex-col items-center justify-center p-8">
					<div class="max-w-2xl text-center space-y-4">
						<div class="p-4 bg-white dark:bg-gray-700 rounded-xl shadow-lg inline-block">
							<MessageCircle
								size="48"
								class="text-blue-500 dark:text-blue-400"
							/>
