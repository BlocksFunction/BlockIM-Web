...
const toggleGroup = (groupId: string) => {
  ...
  if (groupIndex > -1) {
    friendGroups.value[groupIndex].collapsed =
      !friendGroups.value[groupIndex].collapsed;
...
const toggleCategory = (categoryId: string) => {
  ...
  if (categoryIndex > -1) {
    groupCategories.value[categoryIndex].collapsed =
      !groupCategories.value[categoryIndex].collapsed;
    ...
    >
      <div class="flex border-b border-gray-200 dark:border-gray-700">
        <button
          ...
          :class="{
            'text-blue-500 border-b-2 border-blue-500': activeTab === tab.id,
              ...
              >
                <div class="relative flex-shrink-0">
                  ...
                  >
                    ...
                    >
                      {{ truncateText(friend.name, 2, false) }}
                    </span>
                  </div>
                  <div
                    v-if="friend.online"
              ...
              >
                <div class="relative flex-shrink-0">
                  ...
                  >
                    <span class="text-gray-600 dark:text-gray-300 font-medium">
                      {{ truncateText(group.avatar, 2, false) }}
                    </span>
                  </div>
                </div>
                ...
                <div class="ml-3 flex-1 min-w-0">
                  ...
                  <div class="flex items-center justify-between">
                    ...
                    >
                      {{ truncateText(group.lastMessage || "暂无消息", 6) }}
                    </div>
                    <div
      ...
      <div class="p-4 border-t border-gray-200 dark:border-gray-700">
        ...
        >
          <Plus class="w-5 h-5" />
          <span>{{ activeTab === "friends" ? "新建分组" : "新建分类" }}</span>
        </button>
      </div>
    </div>
  </div>
