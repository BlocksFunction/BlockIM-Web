...
import { ref } from 'vue';
import { Send, Mail, Smartphone, FileText, AlertTriangle } from 'lucide-vue-next';
	...
	<div class="flex-1 overflow-y-auto p-6">
		<div class="max-w-3xl mx-auto">
			<div class="flex items-center mb-8">
				...
				<div>
					<h1 class="text-2xl font-bold text-gray-900 dark:text-white">意见反馈</h1>
			...
			<div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6">
				<div class="space-y-6">
					<!-- 反馈类型选择 -->
					<div>
						<h2 class="text-lg font-medium text-gray-900 dark:text-white mb-3">反馈类型</h2>
                ...
                "
					...
					<!-- 反馈内容 -->
					<div>
						<h2 class="text-lg font-medium text-gray-900 dark:text-white mb-3">反馈内容</h2>
						<textarea
					...
					<!-- 联系方式 -->
					<div>
						<h2 class="text-lg font-medium text-gray-900 dark:text-white mb-3">联系方式（可选）</h2>
					...
					<!-- 附件上传 -->
					<div>
						<h2 class="text-lg font-medium text-gray-900 dark:text-white mb-3">添加附件</h2>
						<div class="flex items-center space-x-3">
							<label class="cursor-pointer">
								...
								/>
								<div class="px-4 py-2 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 rounded-lg transition-colors">
									选择文件
								</div>
							</label>
